...
/*
  PostToken gets authentication token
...
func (a *Client) PostToken(params *PostTokenParams) (*PostTokenOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "post_token",
		Method:             "POST",
		PathPattern:        "/api/oauth/v1/token",
	...
	msg := fmt.Sprintf("unexpected success response for post_token: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}

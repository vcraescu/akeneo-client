...
// WithContentType adds the contentType to the post token params
func (o *PostTokenParams) WithContentType(contentType string) *PostTokenParams {
	o.SetContentType(contentType)
	return o
}

// SetContentType adds the contentType to the post token params
func (o *PostTokenParams) SetContentType(contentType string) {
	o.ContentType = contentType
}

// WithBody adds the body to the post token params
func (o *PostTokenParams) WithBody(body PostTokenBody) *PostTokenParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the post token params
func (o *PostTokenParams) SetBody(body PostTokenBody) {
	o.Body = body
}
